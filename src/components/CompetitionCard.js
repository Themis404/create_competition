...
class CompetitionCard extends BaseComponent {
        ...
        <div className="createComp marginTopStandart">
          <form className='positionInput'>
            <div className='textInput width_input'>
              ...
              <p><input className="cardCompForm"
                        value={this.state.content.registrationEndTimestamp}
                        placeholder="DD-MM-YYYY"/></p>
            </div>
          </form>
          <button onClick={() => this.goToState('/competition/' + this.state.content.id + '/create-day')}

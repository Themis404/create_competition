    ...
    <div>
      ...
      <div className='container'>
        <div className="center-block">
          <SearchBar 
              onSearch={ e => context.setState({searchByName: e}, 
              () => context.getCompetitionInfo())}/>
          <div className='btn-group marginBotStandart col-md-12 nonePadding'>
            <button 
                className='btn btn-info heightButton col-md-2'
                onClick={() => context.goToState('/create-competition')}>
              ...
              <thead>
                <tr className="info active">
                  <th 
                      ...
                      onClick={() => context.sortNameCompetitions()}>
                      NAME COMPETITION
                      <span class="fa fa-sort float-right"></span>
                  </th>
                  <th 
                      className="text-center col-md-2" 
                      onClick={() => context.sortDateCompetitions()}>
